...
namespace UnityEditor.AddressableAssets.GUI
{
    ...
    class AddressableAssetSettingsInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                AddressableAssetsWindow.Init(m_AasTarget);
            }
            ...
            if (ProfilesFoldout.IsActive)
            {
                if (m_AasTarget.profileSettings.profiles.Count > 0)
                {
                    ...
                    {
                        currentProfileIndex = profileNames.IndexOf(m_AasTarget.profileSettings.GetProfileName(m_AasTarget.activeProfileId));
        ...
        void DrawRemoteCatalogPaths()
        {
            ...
            AddressableAssetSettings settings = m_AasTarget;
